        ...
        <div style={styles.container}>
            ...
            <main style={styles.main}>
                ...
                <div style={styles.formWrap}>
                    ...
                    <p style={styles.joinText}>NEW USER? <Link to="/signup" style={styles.joinLink}>JOIN US NOW</Link></p>
                </div>
            </main>
        </div>
    );
...
const styles = {
    ...
    joinText: { textAlign: 'center', marginTop: '32px', fontSize: '12px', color: '#999', letterSpacing: '0.5px' },
