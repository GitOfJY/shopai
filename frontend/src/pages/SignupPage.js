        ...
        <div style={styles.container}>
            ...
            <main style={styles.main}>
                ...
                <div style={styles.formWrap}>
                    ...
                    <p style={styles.loginText}>ALREADY HAVE AN ACCOUNT? <Link to="/login" style={styles.loginLink}>LOGIN</Link></p>
                </div>
            </main>
        </div>
    );
...
const styles = {
    ...
    loginText: { textAlign: 'center', marginTop: '32px', fontSize: '12px', color: '#999', letterSpacing: '0.5px' },
